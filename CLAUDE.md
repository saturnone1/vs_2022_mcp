...
- Shared library: Multi-target net48;net9.0

**VSIX Manifest:**
- Version range: `[17.12,18.0)` — supports Visual Studio 2022 17.12 and later VS 2022 updates
...
VS-VSMCP is a Visual Studio 2022 17.12 extension that exposes Visual Studio features as an MCP (Model Context Protocol) server, allowing AI assistants like Claude to interact with VS programmatically via HTTP/SSE.
...
- .NET 9.0 (Server)
- Visual Studio SDK 17.12 (VS 2022)
